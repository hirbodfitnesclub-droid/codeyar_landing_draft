...
export function TaskProgressCard() {
  return (
    <div className="backdrop-blur-xl bg-zinc-950/80 border border-zinc-800 rounded-xl p-5 shadow-[0_0_40px_rgba(139,92,246,0.15)] flex flex-col gap-3">
      {tasks.map((task, index) => (
        ...
        >
          ...
          <div
            className={`text-xs px-2.5 py-1 rounded-md flex items-center gap-2 whitespace-nowrap ${
              task.status === 'done'
