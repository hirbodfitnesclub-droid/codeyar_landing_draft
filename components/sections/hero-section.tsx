...
export function HeroSection() {
  ...
  return (
    <section className="bg-zinc-950 min-h-screen relative flex flex-col lg:grid lg:grid-cols-[40%_60%] p-4 lg:p-0 pt-24 md:pt-32 lg:pt-0 pb-24 lg:pb-0 overflow-hidden" dir="rtl">
      ...
      <div className="flex flex-col justify-center gap-8 pr-8 lg:pr-16 relative z-20 mb-16 lg:mb-0 items-center lg:items-start text-center lg:text-right">
        ...
        <motion.h1 
          ...
          className="text-5xl lg:text-6xl font-bold text-zinc-100 max-w-4xl leading-[1.1]"
        >
          کدنویسی با هوش مصنوعی،<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-l from-purple-400 to-blue-400 drop-shadow-[0_0_20px_rgba(139,92,246,0.4)]">بدون فراموشی کانتکست</span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-zinc-400 text-base lg:text-lg leading-relaxed max-w-2xl"
        >
        ...
        <motion.div 
          ...
          className="mt-16 flex flex-col sm:flex-row items-center lg:items-start lg:justify-start gap-4"
        >
      ...
      <div className="flex flex-col items-center justify-center relative z-10 w-full h-[580px] lg:h-full">
        {/* IDE Mockup */}
        <div className="w-full max-w-[95%] lg:scale-[0.9] h-[580px] flex flex-col backdrop-blur-xl bg-zinc-900/60 border border-zinc-800 rounded-xl overflow-hidden shadow-2xl relative z-10 mx-auto">
            ...
            <div className="flex items-center gap-2 px-2 py-1.5 text-sm text-purple-200 bg-purple-500/10 border border-purple-500/20 rounded-md transition-colors cursor-default mt-1 relative">
              ...
              {phase !== 'idle' && phase !== 'typing' && (
                <motion.div 
                  ...
                  className="flex items-center gap-2 absolute left-2" 
                  dir="ltr"
                >
                  <motion.div 
                    initial={{ scale: 0 }} 
