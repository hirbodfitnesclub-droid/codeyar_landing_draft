    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto mb-10 leading-relaxed text-balance">
          پلتفرمی یکپارچه که به تیم‌ها کمک می‌کند محصولات خود را ۱۰ برابر سریع‌تر بسازند، مستقر کنند و گسترش دهند. بدون پیچیدگی، فقط نتیجه.
        </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-sm text-zinc-500">
                مورد اعتماد بیش از <span className="text-zinc-300 font-medium">۱۰٬۰۰۰+</span> توسعه‌دهنده
              </p>
            </div>
          </div>
        </div>
